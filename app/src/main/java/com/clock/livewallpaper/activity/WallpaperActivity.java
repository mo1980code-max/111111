...
public class WallpaperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        Log.d("CONTENT_DEBUG", "WallpaperActivity.open sectionId=" + sectionId
                + " catalogSections=" + WallpaperCatalog.sections(this).size()
                + " catalogItems=" + WallpaperCatalog.allEntries(this).size()
                + " sourceSize=" + entries.size()
        ...
        recyclerView.post(new Runnable() {
            @Override
            public void run() {
                Log.d("CONTENT_DEBUG", "WallpaperActivity.measured sectionId=" + sectionId
